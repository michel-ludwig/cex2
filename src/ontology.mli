...
(**=============== role difference information ==============**)
val get_RoleDifferenceInformation : t -> RoleDifference.t
...
val add_domain_range_concept_definitions : StringSet.t -> t -> occurrence_hash -> StringSet.t ref -> unit
